  ...
  const Dashboard = () => {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        toast("Ana Sayfa y\xFCklenirken hata olu\u015Ftu", "error");
      } finally {
        setLoading(false);
      }
    };
    ...
    if (loading) return /* @__PURE__ */ React.createElement(Page, { title: "Ana Sayfa" }, /* @__PURE__ */ React.createElement(LoadingSpinner, { text: "Ana Sayfa y\xFCkleniyor..." }));
