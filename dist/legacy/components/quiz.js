(() => {
  ...
  const Quiz = ({ sessionId }) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "quiz-fullscreen" }, /* @__PURE__ */ React.createElement("div", { className: "quiz-topbar" }, /* @__PURE__ */ React.createElement(
      "button",
      {
