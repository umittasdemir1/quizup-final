  ...
  const Result = ({ sessionId, resultId }) => {
    ...
    const downloadPDF = async () => {
      ...
      try {
        ...
        const totalQuestions = ((_h2 = data == null ? void 0 : data.score) == null ? void 0 : _h2.total) || questions.length || 0;
    ...
    return /* @__PURE__ */ React.createElement(
      Page,
      {
        ...
        extra: /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, sessionId && resultId && /* @__PURE__ */ React.createElement(
          "button",
          {
            className: "btn btn-secondary flex items-center gap-2",
            onClick: () => {
              window.location.hash = `#/finish?sessionId=${sessionId}&resultId=${resultId}`;
            }
          },
          /* @__PURE__ */ React.createElement(TrophyIcon, { size: 18, strokeWidth: 2 }),
          " Liderlik Tablosu"
        ), /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary flex items-center gap-2", onClick: downloadPDF }, /* @__PURE__ */ React.createElement(ArrowDownTrayIcon, { size: 18, strokeWidth: 2 }), " PDF \u0130ndir"))
      },
